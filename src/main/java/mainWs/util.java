 ...
 */
public class util {
    static String AUTH_TOKEN = "eoR2sbxVJKJlJAVcGggEa8abXcgo9sn4";
    ...
    public static boolean isAuthenticated(String auth_token) {
	if (auth_token!=null) {
	...
	try {
		...
		if (rs.getString("username").equals(username)) {
			...
			return new String[] { "logedin", rs.getString("student_name") };
		    } else {
			return new String[] { "wrongpass",
				"Bruh ! Thats a Wrong Password \\nCan't you Remember a damn password" };
		    }
